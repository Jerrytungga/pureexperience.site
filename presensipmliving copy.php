...
$ambildata_jadwal = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM `schedule` WHERE id='$nip'"));
              ...
              <div class="card-body" style="height: 350px;overflow: scroll;">
                <table class="table table-striped" id="dailyScheduleTable" >
                    ...
                    <tbody>
                        ...
                        <tr>
                        <td><?= nama($row['nip']); ?></td>
                        <td><span class="badge badge-pill badge-success"><?= $row['p']; ?></span></td>
