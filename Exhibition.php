...
$week = $ambil_max['akhir'];
$poinExhibition = 1;
$masukan_data = mysqli_query($conn, "INSERT INTO `tb_pameran`(`nip`,`batch`,`week`, `E`,`asisten`,`jadwal`) VALUES ('$nip','$angkatan','$week','$poinExhibition','$asisten_','$jadwal')");
if ($masukan_data){
    echo notice(5);
}  else {
  echo '<script type="text/javascript">';
  echo ' alert("Data Exhibition Anda sudah ada!")';  //not showing an alert box.
  echo '</script>';
}
}
}
            ...
            <td style="width:65%; height:30%;">
                <center>
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3" style="background-color: #FFED00;">
